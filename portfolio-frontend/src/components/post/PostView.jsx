...
//       //    const notificationMessage = `${user.nick} 님이 회원님의 게시글을 좋아합니다.`
//       //    dispatch(
//       //       addNotificationThunk({
//       //          userId: post.User.id, // 게시글 작성자에게 알림을 보냄
//       //          message: notificationMessage, // 알림 내용
//       //          postId: id, // 게시글 ID
//       //       })
//       //    )
//       // }
//    }, [dispatch, liked, id, user, post.User?.id])
